...
<template>
  <router-link :to="'/specialist/' + data.slug" class="relative mt-4">
    <img
      class="max-w-full rounded-full w-[160px] h-[160px] md:w-[300px] md:h-[300px] mx-auto pointer-events-none object-cover"
