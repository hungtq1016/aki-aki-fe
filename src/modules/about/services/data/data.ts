...
const quotes = ref<Array<TQuote>>([
    {
        quote: "Các bác sĩ đều thân thiện, nhẹ nhàng với các bé. Đặc biệt, tiệm luôn sát khuẩn bàn khám trước khi đổi bé khám",
        author: "Chị Nguyễn Linh ",
    },
    {
        quote: "Chưa một lần nào đến đây mà bị thất vọng cả. Cảm ơn đội ngũ y bác sĩ của PETPRO rất nhiều vì đã chăm sóc các bạn nhỏ",
        author: "Chị Lan Anh",
    },
    {
        quote: "Bé mình bị giảm bạch cầu, sau 5 ngày điều trị bé ăn uống được và khoẻ lại rất nhiều! Cảm ơn PETPRO.",
        author: "Anh Tô Lâm",
    },
    {
        quote: "Phòng khám sạch sẽ, trang thiết bị hiện đại, bác sĩ tâm huyết. Mèo nhà mình bị nấm nặng mà giờ hết rồi nè. Sẽ quay lại khám chữa và kiểm tra sức khoẻ cho con",
        author: "Anh Văn Sang",
    }
])
