                                ...
                                <div>
                                    ...
                                    <div class="dark:bg-big-stone-950 relative z-20 bg-white">
                                        ...
                                        <select v-model="state.medicineId"
                                            class="border-big-gray-200 dark:border-big-stone-900 dark:bg-big-stone-950 relative z-20 w-full appearance-none rounded border bg-transparent px-12 py-3 outline-none transition">
