...
<template>
  <div class="w-96 bg-white  dark:border-[1px] dark:border-gray-900 dark:bg-gray-800 rounded-lg shadow-lg">
    <div class="flex justify-center space-x-2 py-3 items-center rounded-lg">
      <button type="button" class="-my-1.5 flex flex-none items-center justify-center p-1.5" @click="toPreviousMonth">
    ...
    <div class="mt-2 grid grid-cols-7 text-sm font-inter">
      <button v-for="(day, index) in days" :key="`day-${index}`" type="button"
        @click="selectDay(day)"
