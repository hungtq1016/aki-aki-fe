  ...
  <form @submit.prevent="submit">
    <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
      <div class="w-full sm:w-1/2">
        <label
          class="mb-3 block text-sm font-medium text-black-900 dark:text-gray-50"
          for="fullName"
        ...
        <div class="relative">
          ...
          <input
            ...
            id="fullName"
            :placeholder="$t('form.place_hoder.full_name')"
          />
        </div>
      </div>
      <div class="w-full sm:w-1/2">
        ...
        <div class="relative">
          ...
          <input
            ...
            id="phoneNumber"
            :placeholder="$t('form.place_holder.phone')"
          />
        </div>
      </div>
    </div>
...
const isChange: ComputedRef<boolean> = computed(
  () => JSON.stringify(user) === JSON.stringify(state.value)
)
