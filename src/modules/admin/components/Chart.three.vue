...
<template>
  <div
    class="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-[30px] pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-[30px] xl:col-span-5"
  >
