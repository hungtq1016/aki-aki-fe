<template>
  <div class="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
    ...
    >
      ...
      <div
        class="flex h-full flex-col border-l border-zumthor-100 dark:border-oxford-blue-900 xl:w-3/4"
      >
        <div
            ...
            <div>
              <MenuButton class="inline-flex w-full justify-center">
                <EllipsisHorizontalIcon
                  class="-mr-1 ml-2 h-8 w-8 text-gray-400 hover:text-gray-500"
                  aria-hidden="true"
                />
              </MenuButton>
            </div>
                ...
                <div class="px-1 py-1">
                  <MenuItem v-slot="{ active }">
                    ...
                    >
                      <EditIcon
                        :active="active"
                        class="mr-2 h-5 w-5 text-cerulean-400"
                        aria-hidden="true"
                      />
                      Edit
                    </button>
