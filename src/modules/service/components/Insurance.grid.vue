...
<template>
  <div>
    <div class="mt-5 flex justify-center">
      ...
      >
        ...
        >
          <div
            :class="[
              checked ? 'bg-cerulean-600 text-white' : 'text-gray-500',
    ...
    <div
      class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
    >
